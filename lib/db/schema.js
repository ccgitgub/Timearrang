...
// 小息職務（按崗位，非班別；每人只分配一個職務）
const BREAK_DUTIES = [
  '3樓', '2樓', '1樓', '2樓', '7:45正門', '小息禮堂',
  '2樓(5C)', '7:30禮堂', '7:45正門', '1樓', '4樓', '3樓',
];

// 放學當值職務（按崗位，非班別；每人只分配一個職務）
const DISMISSAL_DUTIES = [
  '2/F', '校車', '禮堂', '1/F', '3號梯', '禮堂前內',
  '禮堂前外', '班牌', '操場閘', '班牌', '3/F', '馬路', '正門',
];
...
const DEFAULT_SLOTS = [
  { label: '第一節',    start: '08:30', end: '09:20',  duties: DEFAULT_DUTIES },
  { label: '第二節前段', start: '09:20', end: '09:45',  duties: DEFAULT_DUTIES },
  { label: '第二節後段', start: '09:45', end: '10:10',  duties: DEFAULT_DUTIES },
  { label: '小息',      start: '10:10', end: '10:25',  duties: BREAK_DUTIES },
  { label: '第三節',    start: '10:25', end: '11:15',  duties: DEFAULT_DUTIES },
  { label: '第四節',    start: '11:15', end: '12:05',  duties: DEFAULT_DUTIES },
  { label: '小息',      start: '12:05', end: '12:10',  duties: BREAK_DUTIES, chainFrom: '第四節' },
  { label: '第五節',    start: '12:10', end: '13:00',  duties: DEFAULT_DUTIES, lockClassTeachers: true },
  { label: '放學當值',  start: '13:00', end: '13:00',  duties: DISMISSAL_DUTIES, exclPrevTeachers: true },
];
...
async function addDefaultSlotsAndDuties(db, scheduleId) {
  for (let s = 0; s < DEFAULT_SLOTS.length; s++) {
    ...
    const slotDuties = slotDef.duties || DEFAULT_DUTIES;
    for (let d = 0; d < slotDuties.length; d++) {
      const dutyName = slotDuties[d];
      const dutyId = (
